...
All runtime config: **`slipiq_env.py`** (matches live `.env` — `DISCORD_DAILY_PICKS_CHANNEL`, `CHANNEL_TEAM_PARLAY`, `PARLAY_API_KEY`, `ODDS_API_*`, `TOMORROW_IO_API_KEY`, etc.). See `.env.example`.
